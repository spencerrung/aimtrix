...
The disposable server disables completed sync-response caching to establish a fresh 30-event initial snapshot. The [live-test configuration note](live-matrix-tests.md#polish-06-extension) records why this is necessary and separates the cache-enabled production reconnect boundary.
